...
class SignUp extends Component{
    ...
    handleSignUp = (event) => {
        ...
        const backendurl = 'http://' + properties.backendhost + ':3001/signup/signupbuyer'
    ...
    render = () => {
        ...
        return(
            ...
            <div className="form-group">
                ...
                <div className="form-group">
                 Name:<br />
                <input type="text" pattern='[a-zA-Z\s]+' required title = "Valid Name"name="name" onChange={this.handleChange} className="form-control"/>
                </div>
                <div className="form-group">
                 Email: <br />
                ...
                <input pattern=".{8,}" required title="8 characters minimum" type="password" className="form-control" name="password" onChange={this.handleChange}/>
                </div>
                <br />
                <div>
